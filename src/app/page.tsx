...
import { LiveTeamPresenceWidget } from '@/components/ui/LiveTeamPresenceWidget';
...
import { TasksNotesView } from '@/components/views/TasksNotesView';
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-[var(--t-background-primary)] text-[var(--t-font-color-primary)] font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        ...
        {/* Dynamic Viewport */}
        <main className="flex-1 flex flex-col min-h-0 overflow-hidden relative pb-[56px] md:pb-0">
          ...
          {currentView === 'follow-ups' && <FollowUpsView />}
          {currentView === 'tasks-notes' && <TasksNotesView />}
